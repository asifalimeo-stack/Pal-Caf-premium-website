// Gallery image manifest. Each entry is a placeholder until real photography
// (from Instagram / a shoot) is dropped into /public/gallery and swapped in here.
...
export const galleryImages: GalleryImage[] = [
  ...
  { id: "g8", tag: "desserts", label: "Croissant selection", tall: true },
  { id: "g9", tag: "customers", label: "Guests enjoying the space" },
  { id: "g10", tag: "drinks", label: "Matcha latte" },
  { id: "g11", tag: "interior", label: "The PAL sign", src: "/brand/pal-sign-cups.jpg" },
  { id: "g12", tag: "desserts", label: "Acai bowl", tall: true },
  { id: "g13", tag: "coffee", label: "Latte art" },
